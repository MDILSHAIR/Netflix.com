    ...
    <Form className='email-form'>
      <Row>
         <Col className='form-control1'>
           <Form.Control placeholder="Email address" type='email' size='lg' className='email-placeholder' style={{backgroundColor:"rgba(0, 0, 0, 0.5)", color:"#fff", borderRadius:"5px", placeholder:"#fff"}} />
         </Col>
       <Col >
       <>
